<script lang="ts">
    ...
    function onFileSelected(file: File) {
        ...
        result = null;
        ocrConfidence = null;
        fileSizeWarning = file.size > 2 * 1024 * 1024; // 2MB warning threshold (compression will be applied)
    }
        ...
        <div class="lg:col-span-2 space-y-6">
            ...
            {#if selectedFile && !processing}
                <div class="glass-card-static p-6 animate-fade-in">
                    ...
                    {#if fileSizeWarning}
                        <div
                            class="mt-6 p-4 bg-amber-50 border border-amber-200 rounded-xl text-amber-800 text-sm font-semibold flex items-center gap-2"
                        >
                            <svg
                                class="w-5 h-5"
                                fill="currentColor"
                            ...
                            Large file detected. Compression will be applied
                            during upload to optimize storage.
                        </div>
                    {/if}
