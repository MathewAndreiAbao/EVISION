...
function calculateComplianceStatus(submissionDate: Date, deadlineDate?: Date): 'compliant' | 'late' | 'non-compliant' {
    ...
    // Matches the SQL function: Monday=compliant, Tuesday=late, Others=non-compliant
...
export async function* runPipeline(
    ...
    try {
        ...
        try {
            ...
            // We'll expose this to the UI via the progress message 
            yield {
                phase: 'hashing',
                progress: 50,
