...
>
	<!-- Logo Section -->
	<a href="/dashboard" class="block p-8 mb-4 no-underline group">
	...
	<!-- Footer Info -->
	{#if $profile}
		<div class="p-6 border-t border-border-subtle bg-surface-muted/30">
...
>
	<div class="flex items-center justify-around p-2">
		{#each mobileNavItems as item}
			...
			<a
				href={item.href}
				class="flex flex-col items-center gap-1 p-2 rounded-xl transition-all duration-300
					{isActive(item.href)
