import { d as attr_class, j as attr, g as escape_html, f as stringify, e as ensure_array_like, t as attr_style, h as head } from "../../../../chunks/index2.js";
import "pdf-lib";
...
function FileDropZone($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    let { accept = ".docx,.pdf", disabled = false } = $$props;
    ...
    {
      $$renderer2.push("<!--[!-->");
      $$renderer2.push(`<div class="animate-fade-in"><div class="w-16 h-16 mx-auto mb-4 rounded-2xl bg-gray-100 flex items-center justify-center text-xs font-bold text-text-muted uppercase">File</div> <p class="text-lg font-bold text-text-primary">${escape_html("Drag & drop your file here")}</p> <p class="text-base text-text-muted mt-2 font-medium">or click to browse</p> <p class="text-xs text-text-muted mt-3">Accepted formats: .docx, .pdf</p></div>`);
    }
...
({
  ...
  APP_URL: public_env.PUBLIC_APP_URL || "https://v0-evision.vercel.app"
});
function _page($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    FileDropZone($$renderer2, { disabled: processing });
    $$renderer2.push(`<!----> `);
    {
      $$renderer2.push("<!--[!-->");
    }
    ...
    const each_array_1 = ensure_array_like(processLog);
